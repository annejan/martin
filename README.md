...
> `.show` [settings] > default**. Built on Bevy 0.19 + `bevy_gaussian_splatting` 8.0.2 (our fork —
...
`ufo` (a flying saucer — metal disc, cyan glass dome, alternating rim lights). The rest are parametric
solids
