...
```bash
cargo run --release --bin splatgen -- list                  # sphere cube torus ring helix galaxy star wave knot mobius supershape lsystem fern menger shell tent pine flame terrain moon
...
cratered moon). The rest are parametric solids (sphere/cube/torus/ring/helix/galaxy/star/wave/knot/
